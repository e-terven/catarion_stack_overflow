...
public class ResourceAnswerController {
    ...
    public ResponseEntity<Long> upReputation(Principal principal,
                                             @PathVariable long questionId, @PathVariable long id) {
        return ResponseEntity.ok(voteAnswerService.upCount(principal.getName(), questionId, id));
    }
}
